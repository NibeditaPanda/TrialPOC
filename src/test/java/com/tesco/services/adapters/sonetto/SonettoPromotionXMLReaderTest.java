...
public class SonettoPromotionXMLReaderTest {
    ...
    private static final String PROMOTIONS_DATA_EXPORT = "src/test/resources/com/tesco/services/adapters/sonetto/PromotionsDataExport.xml";
    private static final String PROMOTIONS_DATA_EXPORT_XSD = "templates/Promotions.xsd";
