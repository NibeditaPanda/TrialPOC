...
public class RPMPromotionDescriptionCSVFileReaderTests {
    ...
    public void shouldReadDescriptionsFromCSV() throws IOException, ColumnNotFoundException {
        rpmPromotionDescriptionCSVFileReader = new RPMPromotionDescriptionCSVFileReader("src/test/resources/com/tesco/services/adapters/rpm/fixtures/PROM_DESC_EXTRACT.csv");
    ...
    public void shouldThrowExceptionGivenOfferIdIsNotFound() throws Exception {
        ...
        this.rpmPromotionDescriptionCSVFileReader = new RPMPromotionDescriptionCSVFileReader("src/test/resources/com/tesco/services/adapters/rpm/readers/promotion_desc/PROM_DESC_EXTRACT_OFFER_ID_NOT_FOUND.csv");
    }
    ...
    public void shouldThrowExceptionGivenZoneIdIsNotFound() throws Exception {
        ...
        this.rpmPromotionDescriptionCSVFileReader = new RPMPromotionDescriptionCSVFileReader("src/test/resources/com/tesco/services/adapters/rpm/readers/promotion_desc/PROM_DESC_EXTRACT_ZONE_ID_NOT_FOUND.csv");
    }
    ...
    public void shouldThrowExceptionGivenDesc1IsNotFound() throws Exception {
        ...
        this.rpmPromotionDescriptionCSVFileReader = new RPMPromotionDescriptionCSVFileReader("src/test/resources/com/tesco/services/adapters/rpm/readers/promotion_desc/PROM_DESC_EXTRACT_CF_DESC1_NOT_FOUND.csv");
    }
    ...
    public void shouldThrowExceptionGivenDesc2IsNotFound() throws Exception {
        ...
        this.rpmPromotionDescriptionCSVFileReader = new RPMPromotionDescriptionCSVFileReader("src/test/resources/com/tesco/services/adapters/rpm/readers/promotion_desc/PROM_DESC_EXTRACT_CF_DESC2_NOT_FOUND.csv");
    }
}
