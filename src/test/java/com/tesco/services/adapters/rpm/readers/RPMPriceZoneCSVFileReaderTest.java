...
public class RPMPriceZoneCSVFileReaderTest {
    ...
    public void shouldReturnDBObject() throws Exception {
        this.rpmPriceZoneCSVFileReader = new RPMPriceZoneCSVFileReader("./src/test/resources/com/tesco/services/adapters/rpm/readers/price_zone/PRICE_ZONE_CORRECT.csv");
    ...
    public void shouldThrowExceptionGivenItemIsNotFound() throws Exception {
        ...
        this.rpmPriceZoneCSVFileReader = new RPMPriceZoneCSVFileReader("./src/test/resources/com/tesco/services/adapters/rpm/readers/price_zone/PRICE_ZONE_ITEM_NOT_FOUND.csv");
    ...
    public void shouldThrowExceptionGivenZoneIdIsNotFound() throws Exception {
        ...
        this.rpmPriceZoneCSVFileReader = new RPMPriceZoneCSVFileReader("./src/test/resources/com/tesco/services/adapters/rpm/readers/price_zone/PRICE_ZONE_ZONE_ID_NOT_FOUND.csv");
    }
    ...
    public void shouldThrowExceptionGivenSellingRetailIsNotFound() throws Exception {
        ...
        this.rpmPriceZoneCSVFileReader = new RPMPriceZoneCSVFileReader("./src/test/resources/com/tesco/services/adapters/rpm/readers/price_zone/PRICE_ZONE_SELLING_RETAIL_NOT_FOUND.csv");
    }
    ...
    public void shouldThrowExceptionGivenSimplePromoRetailIsNotFound() throws Exception {
        ...
        this.rpmPriceZoneCSVFileReader = new RPMPriceZoneCSVFileReader("./src/test/resources/com/tesco/services/adapters/rpm/readers/price_zone/PRICE_ZONE_SIMPLE_PROMO_RETAIL_NOT_FOUND.csv");
    }
}
