...
public class RPMStoreZoneCSVFileReaderTest {
    ...
    public void shouldReadInStoreZoneFile() throws IOException, ColumnNotFoundException {
        rpmStoreZoneReader = new RPMStoreZoneCSVFileReader("src/test/resources/com/tesco/adapters/rpm/fixtures/store_zone.csv");
    ...
    public void shouldThrowExceptionGivenStoreNotFound() throws Exception {
        ...
        rpmStoreZoneReader = new RPMStoreZoneCSVFileReader("src/test/resources/com/tesco/adapters/rpm/readers/store_zone/STORE_ZONE_STORE_NOT_FOUND.csv");
    }
    ...
    public void shouldThrowExceptionGivenZoneIdNotFound() throws Exception {
        ...
        rpmStoreZoneReader = new RPMStoreZoneCSVFileReader("src/test/resources/com/tesco/adapters/rpm/readers/store_zone/STORE_ZONE_ZONE_ID_NOT_FOUND.csv");
    }
    ...
    public void shouldThrowExceptionGivenCurrencyNotFound() throws Exception {
        ...
        rpmStoreZoneReader = new RPMStoreZoneCSVFileReader("src/test/resources/com/tesco/adapters/rpm/readers/store_zone/STORE_ZONE_CURRENCY_CODE_NOT_FOUND.csv");
    }
    ...
    public void shouldThrowExceptionGivenZoneTypeNotFound() throws Exception {
        ...
        rpmStoreZoneReader = new RPMStoreZoneCSVFileReader("src/test/resources/com/tesco/adapters/rpm/readers/store_zone/STORE_ZONE_ZONE_TYPE_NOT_FOUND.csv");
    }
}
