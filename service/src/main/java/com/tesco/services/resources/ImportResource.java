...
public class ImportResource {
    ...
    public ImportResource(Configuration configuration) {
    ...
    public Response importData() {
        try {
            ...
            Controller controller = new Controller(
                    ...
                    configuration.getRPMPromotionDataPath(), configuration.getSonettoPromotionsXMLDataPath(), configuration.getRPMPromotionDescCSVUrl(), configuration.getSonettoPromotionXSDDataPath(), configuration.getSonettoShelfImageUrl());
